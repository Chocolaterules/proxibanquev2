...
<html lang="en">
  ...
  <body id="page-top">
   ...
   <section id="errormessage">
   		<h1 class="section-heading text-uppercase">Félicitations, vous êtes responsable du nouveau crash boursier</h1>
   		<p> Bon, d'accord, pas vraiment. Mais il y a quand même une erreur quelque part, donc veuillez contacter le responsable technique pour la résoudre.<br>
   		N° téléphone : 01 23 45 67 89<br>Adresse mail : quelquun.quelquepart@gmail.com</p>
